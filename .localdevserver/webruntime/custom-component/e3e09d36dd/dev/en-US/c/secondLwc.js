Webruntime.define('lwc/secondLwc', ['lwc', 'lightning/configProvider', 'c/secondchildComp'], function (lwc, configProvider, _cSecondchildComp) { 'use strict';

    _cSecondchildComp = _cSecondchildComp && Object.prototype.hasOwnProperty.call(_cSecondchildComp, 'default') ? _cSecondchildComp['default'] : _cSecondchildComp;
    ...
    **/
    ...
    function tmpl$5($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Demo of render()in lifecycle hook"
        },
        key: 3
      }, [api_text("This is template 1"), api_element("br", {
        key: 0
      }, []), api_element("br", {
        key: 1
      }, []), api_custom_element("lightning-button", _lightningButton, {
        props: {
          "label": "Go to the  template 2"
        },
        key: 2,
        on: {
          "click": _m0 || ($ctx._m0 = api_bind($cmp.onchange1))
        }
      }, [])]), $cmp.showChildCmp ? api_element("div", {
        classMap: {
          "slds-m-vertical_medium": true
        },
        key: 4
      }, [api_text("These are the details!")]) : null, $cmp.showChildCmp ? api_custom_element("c-secondchild-comp", _cSecondchildComp, {
        key: 5
      }, []) : null];
    }
    ...
    tmpl$5.stylesheetTokens = {
      hostAttribute: "lwc-secondLwc_secondLwc-host",
      shadowAttribute: "lwc-secondLwc_secondLwc"
    };
    ...
    function tmpl$6($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("div", {
        key: 0
      }, [api_text(" this is template 2")])];
    }

    var secondtemplate = lwc.registerTemplate(tmpl$6);
    tmpl$6.stylesheets = [];
    tmpl$6.stylesheetTokens = {
      hostAttribute: "lwc-secondLwc_secondchildComp-host",
      shadowAttribute: "lwc-secondLwc_secondchildComp"
    };

    class secondLwc extends lwc.LightningElement {
      constructor() {
        super();
      ...
      render() {
        ...
        if (this.templatenumber === 'temp1') return _tmpl$6;else return secondtemplate;
      }
    ...
    lwc.registerDecorators(secondLwc, {
      fields: ["templatenumber", "showChildCmp"]
    });

    var secondLwc$1 = lwc.registerComponent(secondLwc, {
      tmpl: _tmpl$6
    });
