    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_element("h1", {
        ...
        key: 1
      }, [api_text(" welcome to demo class ")]), api_text("Anil "), api_dynamic($cmp.Greeting), api_text(" !!!"), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "value": "",
          "label": "First Name",
          "name": "drugApiName"
    ...
    class Demo1 extends lwc.LightningElement {
      ...
      onValueChange(event) {
        ...
        this.result = Integer.parseInt(this.fname) + Integer.parseInt(this.lname);
      }

    }

    lwc.registerDecorators(Demo1, {
      fields: ["Greeting", "fname", "lname", "result"]
    });
