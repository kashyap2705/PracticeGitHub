Webruntime.define('lwc/leadCreation', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-input", _lightningInput, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.onValueChange))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        attrs: {
          "data-field-name": $cmp.apiNames.firstName
        },
        props: {
          "type": "text",
          "label": $cmp.labels.firstName
        },
        key: 1,
        on: {
          "change": _m1 || ($ctx._m1 = api_bind($cmp.onValueChange))
        }
      }, []), api_custom_element("lightning-input", _lightningInput, {
        attrs: {
          "data-field-name": $cmp.apiNames.lastName
        },
        props: {
          "type": "text",
          "label": $cmp.labels.lastName
        },
        key: 2,
        on: {
          "change": _m2 || ($ctx._m2 = api_bind($cmp.onValueChange))
        }
      }, [])];
    }
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lwc-leadCreation_leadCreation-host",
      shadowAttribute: "lwc-leadCreation_leadCreation"
    };

    class LeadCreation extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.labels = {
      ...
      getInputField(fieldName) {
        ...
        console.log('return Test***' + JSON.stringify(this.template.querySelector(`lightning-input[data-field-name=${fieldName}]`)));
        console.log('return***' + JSON.stringify(this.template.querySelector(`lightning-input[data-field-name=${fieldName}], lightning-combobox[data-field-name=${fieldName}]`)));
    ...
    lwc.registerDecorators(LeadCreation, {
      track: {
        config: 1
      },
      fields: ["labels", "apiNames"]
    });

    var leadCreation = lwc.registerComponent(LeadCreation, {
      tmpl: _tmpl$k
    });
