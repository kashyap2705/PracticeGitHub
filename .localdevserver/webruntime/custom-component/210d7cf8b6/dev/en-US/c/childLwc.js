Webruntime.define('lwc/childLwc', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-input", _lightningInput, {
        ...
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.handleChnage))
        }
      }, [])];
    }
    ...
    tmpl$l.stylesheetTokens = {
      hostAttribute: "lwc-childLwc_childLwc-host",
      shadowAttribute: "lwc-childLwc_childLwc"
    };

    class ChildLwc extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.progressValue = void 0;
      }

      handleChnage(event) {
        this.progressValue = event.target.value; // Creates the event with the data.
    ...
    lwc.registerDecorators(ChildLwc, {
      publicProps: {
        progressValue: {
          config: 0
        }
    ...
    var childLwc = lwc.registerComponent(ChildLwc, {
      tmpl: _tmpl$k
    });
