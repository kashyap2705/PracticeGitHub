Webruntime.define('lwc/parentCmp', ['lwc', 'lightning/configProvider', 'c/childCmp'], function (lwc, configProvider, _cChildCmp) { 'use strict';

    _cChildCmp = _cChildCmp && Object.prototype.hasOwnProperty.call(_cChildCmp, 'default') ? _cChildCmp['default'] : _cChildCmp;
    ...
    * */
    ...
    function tmpl$n($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        props: {
          ...
          "value": $cmp.strContactName
        },
        key: 0,
        on: {
          "change": _m0 || ($ctx._m0 = api_bind($cmp.changeName))
        }
        ...
        key: 2,
        on: {
          "click": _m1 || ($ctx._m1 = api_bind($cmp.addContact))
        }
      }, []), api_element("div", {
        classMap: {
          "slds-m-top_x-medium": true,
          "slds-p-around_medium": true
        },
        key: 4
      }, [api_custom_element("c-child-cmp", _cChildCmp, {
        key: 3
      }, [])])])])];
    }
    ...
    tmpl$n.stylesheetTokens = {
      hostAttribute: "lwc-parentCmp_parentCmp-host",
      shadowAttribute: "lwc-parentCmp_parentCmp"
    };

    class ParentCmp extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.strContactName = '';
      }
    ...
    lwc.registerDecorators(ParentCmp, {
      fields: ["strContactName"]
    });

    var parentCmp = lwc.registerComponent(ParentCmp, {
      tmpl: _tmpl$m
    });
