Webruntime.define('lwc/helloWorldComponent', ['lwc', 'lightning/configProvider', 'c/leadCreation'], function (lwc, configProvider, _cLeadCreation) { 'use strict';

    _cLeadCreation = _cLeadCreation && Object.prototype.hasOwnProperty.call(_cLeadCreation, 'default') ? _cLeadCreation['default'] : _cLeadCreation;
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_text("hii Anil "), api_dynamic($cmp.Greeting), api_text(" !!!"), api_custom_element("lightning-input", _lightningInput, {
        props: {
          "value": "",
          "label": "First Name",
          "name": "drugApiName"
      ...
      }, []), api_custom_element("c-lead-creation", _cLeadCreation, {
        props: {
          "leadGreeting": $cmp.Greeting
        },
        key: 1
      }, [])];
    }
    ...
    class HelloWorldComponent extends lwc.LightningElement {
      ...
      onValueChange(event) {
        ...
        console.log('config***' + JSON.stringify(this.config)); //this.greeting2 = this.Greeting;
      }

    }

    lwc.registerDecorators(HelloWorldComponent, {
      fields: ["Greeting", "config"]
    });
