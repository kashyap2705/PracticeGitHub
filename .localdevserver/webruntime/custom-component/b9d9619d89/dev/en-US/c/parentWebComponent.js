Webruntime.define('lwc/parentWebComponent', ['c/childWebComponent', 'lwc', 'lightning/configProvider'], function (_cChildWebComponent, lwc, configProvider) { 'use strict';

    _cChildWebComponent = _cChildWebComponent && Object.prototype.hasOwnProperty.call(_cChildWebComponent, 'default') ? _cChildWebComponent['default'] : _cChildWebComponent;
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("c-child-web-component", _cChildWebComponent, {
        key: 0
    ...
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-parentWebComponent_parentWebComponent-host",
      shadowAttribute: "lwc-parentWebComponent_parentWebComponent"
    };

    class ParentWebComponent extends lwc.LightningElement {
      handleClick() {
    ...
    var parentWebComponent = lwc.registerComponent(ParentWebComponent, {
      tmpl: _tmpl$4
    });

    return parentWebComponent;
