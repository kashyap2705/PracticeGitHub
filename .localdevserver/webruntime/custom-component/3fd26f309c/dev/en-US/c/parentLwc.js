Webruntime.define('lwc/parentLwc', ['lwc', 'lightning/configProvider', 'c/childLwc'], function (lwc, configProvider, _cChildLwc) { 'use strict';

    _cChildLwc = _cChildLwc && Object.prototype.hasOwnProperty.call(_cChildLwc, 'default') ? _cChildLwc['default'] : _cChildLwc;
    ...
    **/
    ...
    function tmpl$4($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        ...
        props: {
          "value": $cmp.progressValue,
          "size": "large"
        },
        key: 0
      }, []), api_custom_element("c-child-lwc", _cChildLwc, {
        key: 1,
        on: {
          "progressvaluechange": _m0 || ($ctx._m0 = api_bind($cmp.hanldeProgressValueChange))
        }
      }, [])])])];
    }
    ...
    tmpl$4.stylesheetTokens = {
      hostAttribute: "lwc-parentLwc_parentLwc-host",
      shadowAttribute: "lwc-parentLwc_parentLwc"
    };

    class ParentLwc extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
    ...
    lwc.registerDecorators(ParentLwc, {
      track: {
        progressValue: 1
      }
    });

    var parentLwc = lwc.registerComponent(ParentLwc, {
      tmpl: _tmpl$5
    });
