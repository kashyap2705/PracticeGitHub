Webruntime.define('lwc/secondchildComp', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    function tmpl$3($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-card", _lightningCard, {
        props: {
          "title": "Demo of renderCallback()in lifecycle hook"
        },
        key: 0
      }, []), api_element("div", {
        key: 1
      }, [api_text("        I am from child component    ")])];
    }

    var _tmpl$4 = lwc.registerTemplate(tmpl$3);
    tmpl$3.stylesheets = [];
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-secondchildComp_secondchildComp-host",
      shadowAttribute: "lwc-secondchildComp_secondchildComp"
    };

    class secondchildComp extends lwc.LightningElement {
      constructor() {
        super();
    ...
    var secondchildComp$1 = lwc.registerComponent(secondchildComp, {
      tmpl: _tmpl$4
    });

    return secondchildComp$1;
