Webruntime.define('lwc/demo1', ['lwc', 'lightning/configProvider', 'c/demo2'], function (lwc, configProvider, _cDemo2) { 'use strict';

    _cDemo2 = _cDemo2 && Object.prototype.hasOwnProperty.call(_cDemo2, 'default') ? _cDemo2['default'] : _cDemo2;
    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [$cmp.showMsg ? api_element("h1", {
        key: 0
      }, [api_text(" HIi Anil ")]) : null, $cmp.showMsg ? api_element("p", {
        key: 1
      }, [api_text(" welcome to demo class ")]) : null, $cmp.showMsg ? api_text("Anil ") : null, $cmp.showMsg ? api_dynamic($cmp.Greeting) : null, $cmp.showMsg ? api_text(" !!!") : null, api_custom_element("lightning-input", _lightningInput, {
        props: {
          "value": "",
          "label": "First Name",
          "name": "drugApiName"
      ...
      }, []), api_text("Result Finally is "), api_dynamic($cmp.result), api_custom_element("c-demo2", _cDemo2, {
        props: {
          "demo2greeting": $cmp.Greeting
        },
        key: 4
      }, [])];
    }
    ...
    class Demo1 extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.Greeting = 'welcome to night session';
        this.fname = '';
        this.lname = '';
        this.result = '';
        this.showMsg = false;
    ...
    lwc.registerDecorators(Demo1, {
      fields: ["Greeting", "fname", "lname", "result", "showMsg"]
    });
