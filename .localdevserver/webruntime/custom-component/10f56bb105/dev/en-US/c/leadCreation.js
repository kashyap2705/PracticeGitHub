    ...
    * */
    ...
    function tmpl$l($api, $cmp, $slotset, $ctx) {
      ...
      return [api_custom_element("lightning-input", _lightningInput, {
        ...
        key: 3,
        on: {
          "change": _m3 || ($ctx._m3 = api_bind($cmp.onValueChange))
        }
      }, [])];
    }
    ...
    class LeadCreation extends lwc.LightningElement {
      ...
      async onValueChange(event) {
        ...
        console.log('query selector ***' + JSON.stringify(this.template.querySelector(`lightning-input[data-field-name=${this.apiNames.lastName}]`)));
